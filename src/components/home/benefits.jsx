        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="mb-8 md:mb-4">
            <h2 className="text-lg font-bold mb-6 capitalize">
              Get paid for buying a product you need & Recommending to friends
              🤝
            </h2>
            <p className="text-gray-400 mb-4">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laborum
              aperiam suscipit hic placeat ratione adipisci id? Corporis totam
              iure explicabo! Rerum itaque in et ipsa unde quasi ea id atque?
              Autem rem temporibus neque illum ipsam mollitia suscipit, tempore
              ad ducimus totam quod nisi, laudantium velit amet quidem
              excepturi, consequatur nemo iure corporis! Pariatur tempore nihil
              quos, eum ipsam animi. Qui, id impedit deleniti, quaerat
              laudantium voluptate blanditiis tempora minima ducimus est quo
              laborum! Ullam, optio saepe! Possimus quisquam laudantium optio
